...
def factorial(num):
    if num < 1:
        error ("Cannot get a factorial of a number less than 1")
        return 0
    elif num == 1:
        return  1
    else:
...
def parse(userinput):
    ...
    try:
        ...
        error("Invalif number, first and third calues must be an ineger")
    except SyntaxError:
        error("Invalif operation, the options are: + - * / prime fib fact")
